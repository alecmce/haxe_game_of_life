...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLRequest.hx",23)
	if (((inURL != null()))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLRequest.hx",24)
		this->url = inURL;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLRequest.hx",25)
	this->verbose = false;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLRequest.hx",26)
	this->userPassword = HX_CSTRING("");
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLRequest.hx",27)
	this->cookieString = HX_CSTRING("");
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLRequest.hx",28)
	this->authType = (int)0;
}
;
	return null();
...
Void URLRequest_obj::basicAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLRequest.hx",33)
		this->authType = (int)1;
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLRequest.hx",34)
...
Void URLRequest_obj::digestAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLRequest.hx",39)
		this->authType = (int)2;
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLRequest.hx",40)
		this->userPassword = ((inUser + HX_CSTRING(":")) + inPasswd);
	}
return null();
}
