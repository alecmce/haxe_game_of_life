...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",52)
	super::__construct(null());
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",53)
	this->nmeHandle = (int)0;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",54)
	this->bytesLoaded = (int)0;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",55)
	this->bytesTotal = (int)-1;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",56)
	this->state = (int)0;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",57)
	this->dataFormat = ::nme::net::URLLoaderDataFormat_obj::TEXT_dyn();
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",58)
	if (((request != null()))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",59)
		this->load(request);
	}
}
;
...
::nme::net::URLLoaderDataFormat _switch_1 = (this->dataFormat);
				...
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",80)
						this->onError(e);
						HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",81)
						return null();
					}
				}
			}
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",83)
			this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null()));
		}
		else{
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",87)
			...
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",89)
			if (((this->nmeHandle == null()))){
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",90)
				this->onError(HX_CSTRING("Could not open URL"));
			}
			else{
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",94)
...
::nme::net::URLLoaderDataFormat _switch_2 = (this->dataFormat);
					...
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",141)
					this->nmeHandle = null();
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",142)
					this->dispatchEvent(evt);
				}
			}
			else{
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",145)
				if (((this->state == (int)4))){
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",147)
					...
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",152)
					this->nmeHandle = null();
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",153)
					this->dispatchEvent(evt);
				}
			}
		}
...
Void URLLoader_obj::nmePollData( ){
{
		...
		if ((!(::nme::net::URLLoader_obj::activeLoaders->isEmpty()))){
			...
			for(::cpp::FastIterator_obj< ::nme::net::URLLoader > *__it = ::cpp::CreateFastIterator< ::nme::net::URLLoader >(oldLoaders->iterator());  __it->hasNext(); ){
				...
				{
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",167)
					loader->update();
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",168)
					if (((loader->state == (int)2))){
						HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/net/URLLoader.hx",169)
