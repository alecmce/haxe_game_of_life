...
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Point.hx",40)
	this->x = inX;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Point.hx",41)
	this->y = inY;
}
;
	return null();
...
Void Point_obj::offset( double dx,double dy){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Point.hx",78)
		hx::AddEq(this->x,dx);
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Point.hx",79)
		hx::AddEq(this->y,dy);
	}
return null();
}
...
double Point_obj::distance( ::nme::geom::Point pt1,::nme::geom::Point pt2){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Point.hx",88)
	double dx = (pt1->x - pt2->x);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Point.hx",89)
	double dy = (pt1->y - pt2->y);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Point.hx",90)
