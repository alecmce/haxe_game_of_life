...
::nme::geom::Point Rectangle_obj::set_bottomRight( ::nme::geom::Point p){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",75)
	this->width = (p->x - this->x);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",76)
	this->height = (p->y - this->y);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",77)
	return p->clone();
}
...
Void Rectangle_obj::inflate( double dx,double dy){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",103)
		hx::SubEq(this->x,dx);
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",103)
		hx::AddEq(this->width,(dx * (int)2));
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",104)
		hx::SubEq(this->y,dy);
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",104)
...
bool Rectangle_obj::intersects( ::nme::geom::Rectangle toIntersect){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",127)
	double x0 = (  (((this->x < toIntersect->x))) ? double(toIntersect->x) : double(this->x) );
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",128)
	double x1 = (  (((this->get_right() > toIntersect->get_right()))) ? double(toIntersect->get_right()) : double(this->get_right()) );
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",129)
	if (((x1 <= x0))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",130)
		return false;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",132)
	double y0 = (  (((this->y < toIntersect->y))) ? double(toIntersect->y) : double(this->y) );
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",133)
	double y1 = (  (((this->get_bottom() > toIntersect->get_bottom()))) ? double(toIntersect->get_bottom()) : double(this->get_bottom()) );
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",134)
	return (y1 > y0);
}
...
Void Rectangle_obj::offset( double dx,double dy){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",149)
		hx::AddEq(this->x,dx);
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",150)
		hx::AddEq(this->y,dy);
	}
return null();
}
...
Void Rectangle_obj::offsetPoint( ::nme::geom::Point point){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",155)
		hx::AddEq(this->x,point->x);
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",156)
...
::nme::geom::Rectangle Rectangle_obj::transform( ::nme::geom::Matrix m){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",163)
	double tx0 = ((m->a * this->x) + (m->c * this->y));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",164)
	double tx1 = tx0;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",165)
	double ty0 = ((m->b * this->x) + (m->d * this->y));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",166)
	double ty1 = tx0;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",168)
	double tx = ((m->a * ((this->x + this->width))) + (m->c * this->y));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",169)
	double ty = ((m->b * ((this->x + this->width))) + (m->d * this->y));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",170)
	if (((tx < tx0))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",170)
		tx0 = tx;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",171)
	if (((ty < ty0))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",171)
		ty0 = ty;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",172)
	if (((tx > tx1))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",172)
		tx1 = tx;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",173)
	if (((ty > ty1))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",173)
		ty1 = ty;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",175)
	tx = ((m->a * ((this->x + this->width))) + (m->c * ((this->y + this->height))));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",176)
	ty = ((m->b * ((this->x + this->width))) + (m->d * ((this->y + this->height))));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",177)
	if (((tx < tx0))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",177)
		tx0 = tx;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",178)
	if (((ty < ty0))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",178)
		ty0 = ty;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",179)
	if (((tx > tx1))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",179)
		tx1 = tx;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",180)
	if (((ty > ty1))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",180)
		ty1 = ty;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",182)
	tx = ((m->a * this->x) + (m->c * ((this->y + this->height))));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",183)
	ty = ((m->b * this->x) + (m->d * ((this->y + this->height))));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",184)
	if (((tx < tx0))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",184)
		tx0 = tx;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",185)
	if (((ty < ty0))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",185)
		ty0 = ty;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",186)
	if (((tx > tx1))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",186)
		tx1 = tx;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",187)
	if (((ty > ty1))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",187)
		ty1 = ty;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",189)
...
Void Rectangle_obj::extendBounds( ::nme::geom::Rectangle r){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",194)
		double dx = (this->x - r->x);
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",195)
		if (((dx > (int)0))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",197)
			hx::SubEq(this->x,dx);
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",198)
			hx::AddEq(this->width,dx);
		}
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",200)
		double dy = (this->y - r->y);
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",201)
		if (((dy > (int)0))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",203)
			hx::SubEq(this->y,dy);
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",204)
			hx::AddEq(this->height,dy);
		}
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",206)
		if (((r->get_right() > this->get_right()))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",207)
			this->set_right(r->get_right());
		}
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",208)
		if (((r->get_bottom() > this->get_bottom()))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/geom/Rectangle.hx",209)
