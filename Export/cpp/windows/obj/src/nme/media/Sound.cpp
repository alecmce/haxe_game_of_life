...
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",23)
	super::__construct(null());
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",24)
	this->bytesLoaded = this->bytesTotal = (int)0;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",25)
	this->nmeLoading = false;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",26)
	if (((stream != null()))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",27)
...
Void Sound_obj::close( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",32)
		if (((this->nmeHandle != null()))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",33)
			::nme::media::Sound_obj::nme_sound_close(this->nmeHandle);
		}
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",34)
		this->nmeHandle = (int)0;
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",35)
		this->nmeLoading = false;
	}
return null();
}
...
{
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",40)
		this->bytesLoaded = this->bytesTotal = (int)0;
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",41)
		this->nmeHandle = ::nme::media::Sound_obj::nme_sound_from_file(stream->url,forcePlayAsMusic);
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",42)
		if (((this->nmeHandle == null()))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",43)
			hx::Throw ((HX_CSTRING("Could not load:") + stream->url));
		}
		else{
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",48)
			this->nmeLoading = true;
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",49)
			this->nmeLoading = false;
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",50)
...
double Sound_obj::nmeGetLength( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",88)
	if (((bool((this->nmeHandle == null())) || bool(this->nmeLoading)))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",89)
		return (int)0;
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",90)
...
{
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",102)
		this->nmeCheckLoading();
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",103)
		if (((bool((this->nmeHandle == null())) || bool(this->nmeLoading)))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",104)
			return null();
		}
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/Sound.hx",107)
...
Dynamic Sound_obj::__Field(const ::String &inName)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"isBuffering") ) { return nmeIsBuffering(); }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"nmeGetLength") ) { return nmeGetLength_dyn(); }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"nmeIsBuffering") ) { return nmeIsBuffering_dyn(); }
		break;
	case 15:
