...
Void SoundChannel_obj::stop( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/SoundChannel.hx",44)
...
double SoundChannel_obj::nmeGetLeft( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/SoundChannel.hx",98)
...
double SoundChannel_obj::nmeGetRight( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/SoundChannel.hx",105)
...
double SoundChannel_obj::nmeGetPosition( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/SoundChannel.hx",112)
		...
		if (((::nme::media::SoundChannel_obj::nmeIncompleteList->length > (int)0))){
			...
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/SoundChannel.hx",74)
			{
				...
				while(((_g < _g1->length))){
					...
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/SoundChannel.hx",74)
					++(_g);
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/SoundChannel.hx",76)
			...
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/SoundChannel.hx",84)
...
bool SoundChannel_obj::nmeCompletePending( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/media/SoundChannel.hx",91)
