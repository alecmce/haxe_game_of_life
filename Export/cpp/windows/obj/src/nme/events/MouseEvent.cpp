...
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",39)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",41)
	this->localX = in_localX;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",42)
	this->localY = in_localY;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",43)
	this->relatedObject = in_relatedObject;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",44)
	this->ctrlKey = in_ctrlKey;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",45)
	this->altKey = in_altKey;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",46)
	this->shiftKey = in_shiftKey;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",47)
	this->buttonDown = in_buttonDown;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",48)
	this->delta = in_delta;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",49)
	this->commandKey = in_commandKey;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",50)
...
::nme::events::MouseEvent MouseEvent_obj::nmeCreate( ::String inType,Dynamic inEvent,::nme::geom::Point inLocal,::nme::display::InteractiveObject inTarget){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",62)
	int flags = inEvent->__Field(HX_CSTRING("flags"));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",63)
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",69)
	evt->stageX = inEvent->__Field(HX_CSTRING("x"));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",70)
	evt->stageY = inEvent->__Field(HX_CSTRING("y"));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",71)
	evt->target = inTarget;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/MouseEvent.hx",72)
	return evt;
}
