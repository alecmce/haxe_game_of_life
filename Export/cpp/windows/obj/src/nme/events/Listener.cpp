...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/EventDispatcher.hx",137)
	this->mListner = inListener;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/EventDispatcher.hx",138)
	this->mUseCapture = inUseCapture;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/EventDispatcher.hx",139)
	this->mPriority = inPriority;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/EventDispatcher.hx",140)
...
bool Listener_obj::Is( Dynamic inListener,bool inCapture){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/EventDispatcher.hx",144)
...
Void Listener_obj::dispatchEvent( ::nme::events::Event event){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/events/EventDispatcher.hx",149)
		this->mListner(event);
	}
return null();
}
