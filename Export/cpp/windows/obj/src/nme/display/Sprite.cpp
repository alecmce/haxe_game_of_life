...
{
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/Sprite.hx",13)
		if (((this->nmeGetStage() != null()))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/Sprite.hx",15)
...
Void Sprite_obj::stopDrag( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/Sprite.hx",19)
		if (((this->nmeGetStage() != null()))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/Sprite.hx",21)
