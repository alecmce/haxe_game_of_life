...
Void ManagedStage_obj::resize( int inWidth,int inHeight){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/ManagedStage.hx",54)
...
Void ManagedStage_obj::nmeRender( bool inSendEnterFrame){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/ManagedStage.hx",60)
		this->beginRender();
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/ManagedStage.hx",61)
		this->super::nmeRender(inSendEnterFrame);
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/ManagedStage.hx",62)
		this->endRender();
	}
return null();
}
...
double ManagedStage_obj::nmeDoProcessStageEvent( Dynamic inEvent){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/ManagedStage.hx",67)
	this->nmePollTimers();
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/ManagedStage.hx",68)
	double wake = this->super::nmeDoProcessStageEvent(inEvent);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/ManagedStage.hx",69)
	this->setNextWake(wake);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/ManagedStage.hx",70)
	return wake;
}
...
Void ManagedStage_obj::pumpEvent( Dynamic inEvent){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/ManagedStage.hx",74)
...
Void ManagedStage_obj::sendQuit( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/ManagedStage.hx",79)
