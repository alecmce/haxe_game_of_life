...
bool Bitmap_obj::nmeSetSmoothing( bool inSmooth){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/Bitmap.hx",37)
	this->smoothing = inSmooth;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/Bitmap.hx",38)
	this->nmeRebuid();
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/Bitmap.hx",39)
	return inSmooth;
}
...
::nme::display::BitmapData Bitmap_obj::nmeSetBitmapData( ::nme::display::BitmapData inBitmapData){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/Bitmap.hx",44)
	this->bitmapData = inBitmapData;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/Bitmap.hx",45)
	this->nmeRebuid();
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/nme/display/Bitmap.hx",46)
	return inBitmapData;
}
