...
Void ApplicationMain_obj::main( ){
{
		...
		Void run(){
{
				HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",9)
				::Main_obj::main();
			}
			return null();
		}
		...
		HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",7)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)30,(int)16777215,(int(::nme::Lib_obj::HARDWARE) | int(::nme::Lib_obj::RESIZABLE)),HX_CSTRING("NME01"),HX_CSTRING("com.joshuagranick.haxe.nmetemplate"),null());
	}
return null();
}
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	...
	HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",22)
	return null();
}
