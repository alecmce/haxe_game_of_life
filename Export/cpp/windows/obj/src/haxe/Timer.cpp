...
Void Timer_obj::stop( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",132)
		if ((this->mRunning)){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",136)
			this->mRunning = false;
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",137)
...
Void Timer_obj::nmeCheck( double inTime){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",171)
		if (((inTime >= this->mFireAt))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",175)
			hx::AddEq(this->mFireAt,this->mTime);
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",176)
			this->run();
		}
	}
return null();
...
double Timer_obj::nmeNextWake( double limit){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",148)
	{
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",148)
			++(_g);
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",150)
			double sleep = (timer->mFireAt - now);
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",152)
			if (((sleep < limit))){
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",154)
				limit = sleep;
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",156)
				if (((limit < (int)0))){
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",156)
					return (int)0;
				}
...
Void Timer_obj::nmeCheckTimers( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",185)
		double now = ::haxe::Timer_obj::GetMS();
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",187)
		{
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",187)
			int _g = (int)0;
			Array< ::haxe::Timer > _g1 = ::haxe::Timer_obj::sRunningTimers;
...
::haxe::Timer Timer_obj::delay( Dynamic f,int time){
	...
	Void run(){
{
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",209)
			t->__get((int)0)->stop();
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\dev\\nme/haxe/Timer.hx",210)
